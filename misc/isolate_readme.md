...
Limit size of core files created when a process crashes to _size_ kilobytes. Defaults to zero, meaning that no core files are produced inside the sandbox.
